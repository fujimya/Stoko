...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="" class="logo">
      ...
      <span class="logo-lg"><b>Stoko</b></span>
    </a>
      ...
      <!-- sidebar menu: : style can be found in sidebar.less -->
       <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <?php }?>
            <li><a href="<?php echo base_url();?>Suplier"><i class="fa fa-circle-o"></i> Data Suplier</a></li>
            <li><a href="<?php echo base_url();?>Customer"><i class="fa fa-circle-o"></i> Data Customer</a></li>
